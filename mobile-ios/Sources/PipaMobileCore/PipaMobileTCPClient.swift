...
public actor PipaMobileTCPClient {
    ...
    static func parseCapabilities(_ value: Any?) throws -> [String: [String: Any]] {
    ...
    private static let booleanCapabilityFields: Set<String> = [
        ...
        "open_web", "open_contact", "contact_aliases_configured", "prepare_message", "send_message", "requires_manual_send",
