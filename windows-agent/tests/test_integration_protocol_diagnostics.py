...
from tools.integration_protocol_diagnostics import (  # noqa: E402
    ...
    READ_ONLY_INTEGRATION_CASE_COUNT,
...
class IntegrationProtocolDiagnosticsTests(unittest.TestCase):
    def test_all_external_integration_tools_use_confirmation_and_redacted_results(self):
        ...
        self.assertEqual(result["read_only_commands_checked"], READ_ONLY_INTEGRATION_CASE_COUNT)
        ...
        self.assertEqual(
            ...
            INTEGRATION_CASE_COUNT + VOICE_INTEGRATION_CASE_COUNT + READ_ONLY_INTEGRATION_CASE_COUNT,
        )
