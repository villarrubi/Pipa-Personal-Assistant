...
class DiagnosticsTests(unittest.TestCase):
    ...
    def test_self_test_passes_without_optional_league_client(self, find_client):
        ...
        self.assertEqual(result["checks"]["command_routes"]["recognized_commands"], 76)
        self.assertEqual(result["checks"]["command_routes"]["confirmation_gated_commands"], 57)
        self.assertEqual(result["checks"]["command_routes"]["structured_commands"], 20)
