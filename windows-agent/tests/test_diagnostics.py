...
class DiagnosticsTests(unittest.TestCase):
    ...
    def test_self_test_passes_without_optional_league_client(self, find_client):
        ...
        self.assertEqual(result["checks"]["command_routes"]["recognized_commands"], 56)
        self.assertEqual(result["checks"]["command_routes"]["confirmation_gated_commands"], 38)
        self.assertEqual(result["checks"]["command_routes"]["structured_commands"], 18)
        ...
        self.assertEqual(result["checks"]["integration_policy"]["confirmation_mapped_tools"], 19)
