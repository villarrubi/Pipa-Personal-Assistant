...
$requiredPatterns = @(
    ...
    @($localIntegrationLinks, 'PipaMobileLocalIntegrationLinks', 'wa.me', 'discord.com', 'isSafeMessageText', 'normalizeSnowflake', 'first != "0"', 'human'),
