...
$requiredPatterns = @(
    ...
    @($appleMusic, 'MusicCatalogSearchRequest', 'MusicAuthorization', 'SystemMusicPlayer', 'search(term:', 'searchGeneration', 'guard self.searchGeneration == generation', 'play(result:', 'skipToNextEntry', 'skipToPreviousEntry', 'player.stop()', 'previousTrack()', 'stopPlayback()', 'clearEphemeralSearchState()', 'PipaMobileTextPolicy'),
