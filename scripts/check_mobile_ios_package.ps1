...
$requiredPatterns = @(
    ...
    @($protocol, 'Curve25519.Signing', 'ChaChaPoly', 'HKDF<SHA256>.deriveKey', 'sharedSecretData', 'maxFrameBytes', 'publicKeyDigest(forPublicKeyData', 'encodeBase64URL(data) == value', 'sequence < UInt64.max', 'closed = true', 'guard Set(frame.keys) == Self.recordFields', 'PipaMobileTextPolicy', 'containsDisplayControl', 'isSafeMessageText'),
